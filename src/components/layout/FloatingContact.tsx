  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-3">
      ...
      >
        <WhatsAppIcon />
        {/* Tooltip */}
        <span className="absolute right-full mr-3 px-3 py-2 bg-foreground text-primary-foreground text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          واتساب
        </span>
      </a>
